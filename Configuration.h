 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 437.1, 437.1, 209.3, 209.3 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          {300, 300, 40, 40, 40, 40 ,40 }
 ...
 *
 * Also requires: BABYSTEPPING, BABYSTEP_, Z_SAFE_HOMING,
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 0, -1.57 }
...
//
...
#ifndef FIL_RUNOUT_PIN2 
  #define FIL_RUNOUT_PIN2 PG13
#endif

  #ifndef FIL_RUNOUT_PIN3 
  #define FIL_RUNOUT_PIN3 PG14
#endif

  #ifndef FIL_RUNOUT_PIN4 
  #define FIL_RUNOUT_PIN4 PG15
#endif

  #ifndef FIL_RUNOUT_PIN5 
  #define FIL_RUNOUT_PIN5 PG11
#endif

    #ifndef FIL_RUNOUT_PIN6 
  #define FIL_RUNOUT_PIN6 PG10
#endif
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 3
    ...
    #define NUM_MOTION_SENSORS 4
   // #define NUM_SWITCH_SENSORS 4

  #ifndef FIL_MOTION_PIN  
    #define FIL_MOTION_PIN PG12
  #endif

  #ifndef FIL_MOTION2_PIN
    #define FIL_MOTION2_PIN2 PG13
  #endif

  #ifndef FIL_MOTION3_PIN 
    #define FIL_MOTION3_PIN3 PG14
  #endif

    #ifndef FIL_MOTION4_PIN  
      #define FIL_MOTION4_PIN4 PG15
  #endif

  #ifndef  FIL_SWITCH_PIN  
    #define FIL_SWITCH_PIN PG11
  #endif

  #ifndef  FIL_SWITCH2_PIN  
    #define FIL_SWITCH2_PIN2 PG10
  #endif

  #ifndef  FIL_SWITCH3_PIN  
    #define FIL_SWITCH_PIN3 PG11
  #endif

    #ifndef  FIL_SWITCH4_PIN  
    #define FIL_SWITCH4_PIN4 PG10
  #endif
